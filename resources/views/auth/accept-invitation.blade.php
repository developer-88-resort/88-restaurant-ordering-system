<x-guest-layout>
    <div class="w-full max-w-sm">
        ...
        <p class="mb-4 text-sm text-[#6F6258] text-center">
            {{ __('Welcome! Create a password to finish setting up your account.') }}
        </p>
        ...
        <form method="POST" action="{{ route('invitation.store') }}">
            ...
            <input
                ...
                value="{{ $email }}"
                readonly
                class="w-full mb-4 rounded-xl border border-[#D9CCBA] bg-gray-100 px-4 py-3 text-sm text-[#333] outline-none cursor-not-allowed"
            >
